  ...
  <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
      <div>
        ...
        Transform content creation with Generative AI. Effortlessly produce high-quality, engaging copy at scale, empowering your business to excel in the digital landscape with speed and precision.
        </p>
        {/* Buttons */}
