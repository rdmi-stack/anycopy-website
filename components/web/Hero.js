            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-center">
              <div>
                <a
                  ...
                  className="inline-block bg-gray-900 text-white text-lg md:text-xl font-semibold py-4 px-8 rounded-md hover:bg-gray-800 transition-colors mx-auto md:mx-0"
                >
                  Get Started - It's Free
                </a>
                <div className="mt-4 md:mt-0 md:ml-4 md:flex md:justify-center md:w-full">
