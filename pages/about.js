          ...
          <div className="flex flex-wrap items-center justify-between -mx-4">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="mt-10 lg:mt-0">
                ...
                AnyCopy is more than just another AI writing tool. We're harnessing the latest advancements in AI, including GPT-3.5, GPT-4, and Claude, to deliver a content platform that understands your project briefs and adapts to your brand voice.
                </p>
